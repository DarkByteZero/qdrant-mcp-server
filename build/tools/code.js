...
export function registerCodeTools(server, deps) {
    ...
    }, withToolLogging("index_codebase", async ({ path, forceReindex, extensions, ignorePatterns }, extra) => {
    ...
    // reindex_changes
    server.registerTool("reindex_changes", {
