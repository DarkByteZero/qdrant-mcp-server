...
describe("GitSynchronizer", () => {
    ...
    describe("updateSnapshot", () => {
        it("should write snapshot to file", async () => {
            ...
            expect(fs.mkdir).toHaveBeenCalledWith(expect.stringContaining("git-snapshots"), { recursive: true });
            // Check the file was written with correct data (JSON may be formatted)
            expect(fs.writeFile).toHaveBeenCalledWith(expect.stringContaining(".tmp"), expect.stringMatching(/lastCommitHash.*def456/s));
