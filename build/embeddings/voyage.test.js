...
describe("VoyageEmbeddings", () => {
    ...
    describe("constructor", () => {
        ...
        it("should use custom base URL", () => {
            const customEmbeddings = new VoyageEmbeddings("test-api-key", "voyage-2", undefined, undefined, "https://custom.voyage.com");
        ...
        it("should accept custom input type", () => {
            const queryEmbeddings = new VoyageEmbeddings("test-api-key", "voyage-2", undefined, undefined, undefined, "query");
    ...
    describe("embed", () => {
        ...
        it("should use custom base URL", async () => {
            const customEmbeddings = new VoyageEmbeddings("test-api-key", "voyage-2", undefined, undefined, "https://custom.voyage.com/v1");
            ...
            expect(mockFetch).toHaveBeenCalledWith("https://custom.voyage.com/v1/embeddings", expect.any(Object));
        });
        it("should throw error if no embedding returned", async () => {
            ...
            await expect(embeddings.embed("test")).rejects.toThrow("No embedding returned from Voyage AI API");
        });
    ...
    describe("embedBatch", () => {
        ...
        it("should throw error if no embeddings returned", async () => {
            ...
            await expect(embeddings.embedBatch(["text1"])).rejects.toThrow("No embeddings returned from Voyage AI API");
        });
    ...
    describe("rate limiting", () => {
        ...
        it("should throw error after max retries exceeded", async () => {
            ...
            await expect(rateLimitEmbeddings.embed("test text")).rejects.toThrow("Voyage AI API rate limit exceeded after 2 retry attempts");
            expect(mockFetch).toHaveBeenCalledTimes(3);
        });
...
//# sourceMappingURL=voyage.test.js.map