...
describe("CohereEmbeddings", () => {
    ...
    describe("constructor", () => {
        ...
        it("should accept custom input type", () => {
            const searchQueryEmbeddings = new CohereEmbeddings("test-api-key", "embed-english-v3.0", undefined, undefined, "search_query");
    ...
    describe("rate limiting", () => {
        ...
        it("should throw error after max retries exceeded", async () => {
            ...
            await expect(rateLimitEmbeddings.embed("test text")).rejects.toThrow("Cohere API rate limit exceeded after 2 retry attempts");
            expect(mockClient.embed).toHaveBeenCalledTimes(3);
        });
